...
class Extension {
    ...
    refreshIndicator() {
        const nextEvents = DateHelperFunctions.getNextEventsToDisplay(this._indicator._calendarSource);
        const eventStatus = DateHelperFunctions.getNextEventsToDisplay(nextEvents);
